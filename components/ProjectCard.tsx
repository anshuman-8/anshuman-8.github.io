...
function ProjectCard({title,tags,description,link,source,isDark}:IProjects,) {
  ...
  return (
    <div className='bg-white rounded-xl py-3 px-2 md:max-w-[300px] mx-1 my-2 shadow-2xl hover:shadow-sm dark:bg-slate-600'>
      ...
      <p className={isDark?"text-sm my-2 mx-2 text-slate-300":"text-sm my-2 mx-2 text-grey-600"}>{tags.map((tag)=>{return tag+", "})}</p>
      ...
      <div className='my-2 mx-4'>
        ...
        <div className=''>
        <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill={isDark?'none':'#ffffff'} stroke='#000000' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
